...
final List<Application> mockApplications = [
  ...
  Application(
    id: 'a3',
    job: mockJobs[4],
    title: mockJobs[4].title,
    company: mockJobs[4].company,
    location: mockJobs[4].location,
  ...
  Application(
    id: 'a4',
    job: mockJobs[6],
    title: mockJobs[6].title,
    company: mockJobs[6].company,
    location: mockJobs[6].location,
    status: ApplicationStatus.rejected,
  ...
  Application(
    id: 'a5',
    job: mockJobs[7],
    title: mockJobs[7].title,
    company: mockJobs[7].company,
    location: mockJobs[7].location,
